...
This directory contains translations of healthcare provider-related code sets to OMOP CDM standard concepts.  
Below is a brief description of each code set, along with the corresponding CSV files located in this directory.

## Code Sets

### 1. Specialties Codes
These codes represent the classification of the healthcare professionals' specialities.
...
- **Description:** This file contains a list of codes representing the healthcare professionals' specialities, along with their mappings to OMOP CDM standard concepts.
...
- **source_code_type:** The type of the source code (e.g., specialities).
...
- **target_concept_class_id:** The class ID of the target Concept (e.g., Physician Speciality, Provider).
